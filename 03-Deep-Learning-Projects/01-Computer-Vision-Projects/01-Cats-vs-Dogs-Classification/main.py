#!/usr/bin/env python3
"""Command line interface for training and evaluating the cat/dog classification model."""
...
from src.core import CatDogModel
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Train and evaluate cat/dog classification model'
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help='Directory containing cats/ and dogs/ subdirectories'
    )
...
def main():
    ...
    try:
        stats = validate_data_directory(args.data_dir)
        logger.info("Found %d cat and %d dog images", 
    ...
    try:
        ...
        logger.error("Failed to create data generators: %s", str(e))
        return 1
