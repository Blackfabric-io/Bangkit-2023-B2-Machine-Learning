...
from src.core import MNISTModel, AccuracyCallback
...
def test_callback_initialization():
    ...
    threshold = 0.95
    callback = AccuracyCallback(threshold=threshold)
...
def test_callback_stops_training():
    ...
    model = MNISTModel()
    callback = AccuracyCallback(threshold=0.0)  # Set threshold to 0 to ensure stopping
